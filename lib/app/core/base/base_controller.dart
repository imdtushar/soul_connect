...
abstract class BaseController extends GetxController {
  ...
  @override
  void onClose() {
    _messageController.subject.isClosed ? _messageController.close() : null;
    _refreshController.subject.isClosed ? _refreshController.close() : null;
    _pageSateController.subject.isClosed ? _pageSateController.close() : null;
    super.onClose();
  }
}
